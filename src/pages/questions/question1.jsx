...
const Question1 = () => {
  ...
  return (
    <>
      <Head>
        <title>Question 1 | Quick Glance | Solve It Out</title>
      </Head>
      <div className="grid place-items-center w-full my-12 font-poppins max-w-5xl mx-auto">
        ...
        <div className="w-full px-6 py-6 text-lg leading-loose">
          ...
          Implement the functionality to manage the cart using the useState
          hook. The cart should keep track of the total number of items and the
          total price. Additionally, provide a button to clear the cart, which
          should reset the state. <br /> <br />
          Hints: <br />
          ...
          <br />
          ■ Create functions to add items to the cart, remove items from the
          cart, and clear the cart.
          <br />
        </div>
